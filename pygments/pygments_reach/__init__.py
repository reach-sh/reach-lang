    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(for|in|while|do|break|return|continue|match|switch|case|default|if|else|'
             ...
             # Reach ones
             r'interact|commit|exit|only|each|race|fork|paySpec|define|parallelReduce|when|timeout|timeRemaining|api|throwTimeout|publish|pay|declassify|transfer|'
            ...
            (r'(Array|Boolean|Date|Error|Function|Foldable|Math|netscape|'
             ...
             r'deploy|balance|digest|implies|ensure|hasRandom|makeCommitment|checkCommitment|closeTo|lastConsensusTime|remote|lock|'
