    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(Array|Boolean|Date|Error|Function|Foldable|Math|netscape|'
             ...
             # The reach ones
             r'UInt|Int|FixedPoint|Interval|IntervalType|Reach|App|Fun|Null|Bool|Bytes|Address|Contract|Token|Tuple|Struct|Participant|ParticipantClass|View|Events|Data|Digest|Map|Set|Refine|Anybody|API|verifyArithmetic|verifyPerConnector|connectors|ETH|ALGO|CFX|'
