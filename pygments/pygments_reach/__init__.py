    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(for|in|while|do|break|return|continue|match|switch|case|default|if|else|'
             ...
             # Reach ones
             r'interact|commit|exit|only|each|race|fork|parallelReduce|when|timeout|timeRemaining|throwTimeout|publish|pay|declassify|transfer|'
            ...
            (r'(Array|Boolean|Date|Error|Function|Foldable|Math|netscape|'
             ...
             # The reach ones
             r'UInt|Int|FixedPoint|Interval|IntervalType|Reach|App|Fun|Null|Bool|Bytes|Address|Tuple|Struct|Participant|ParticipantClass|Data|Digest|Map|Set|Refine|Anybody|deployMode|verifyArithmetic|verifyPerConnector|connectors|ETH|ALGO|'
