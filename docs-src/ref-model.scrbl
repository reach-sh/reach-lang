...
A @deftech{value} is either: the @litchar{null} value, a boolean, an unsigned integer of 256 bits, a string of bytes, a @tech{digest}, an @tech{address}, a fixed tuple of @tech{values}, a statically-sized homogeneous array of @tech{values}, or a fixed record of @tech{values}.
