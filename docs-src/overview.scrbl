...
(If you add @exec{REACH_CONNECTOR_MODE=ETH-test-ganache-embedded} to the command line, then Reach will use @link["https://www.trufflesuite.com/ganache"]{Ganache} instead.)}
