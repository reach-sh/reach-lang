...
@itemlist[
 ...
 @item{Alice's @reachin{getRelay} function (lines 25 through 31) creates the new account and communicates it "outside of the network" through the aforementioned Promise.}
 @item{Bob's thread (lines 33 through 47) waits for the Promise to resolve and then connects to the application with this new account.}
 @item{The Relay's @reachin{getBob} function (lines 42 through 45) returns his own address to receive the funds.}
]
