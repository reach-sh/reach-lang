...
because reach will use it in specific ways. Refer to the @litchar{Makefile} generated by @exec{reach scaffold} for hints on how to get it right.

@itemlist[
  @item{
    Various reach commands may invoke @exec{make build}, which is assumed to build the Docker image for your app.}
  @item{
