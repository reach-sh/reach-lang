...
The @jsin{ctc} argument is the result of a call to the functions @jsin{acc.deploy} or @jsin{acc.attach} provided by the @seclink["ref-stdlib-js"]{JavaScript standard library}.
...
The values in this object must match those specified by the @seclink["ref-stdlib-js-types"]{JavaScript standard library}.
