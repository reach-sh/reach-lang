...
You can now follow the instructions in the @seclink["ref-install"]{reference manual on installation} or the @seclink["rps-1"]{first part of the tutorial} to download, install, and execute all Reach commands.
