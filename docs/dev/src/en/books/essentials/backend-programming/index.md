...
See [Install and Run](/en/books/essentials/getting-started/install-and-run/).
...
This section describes the fundamental assumptions and concepts of Reach. [Evaluation Model]() discusses the run-time model. [Compilation Model]() explores transformations relevant to developers. [Syntax Model]() details Reach language syntax.
