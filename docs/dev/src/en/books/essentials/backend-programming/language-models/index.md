...
This page describes the fundamental concepts and assumptions of Reach. [Evaluation Model](#evaluation-model) details the run-time model. [Compilation Model](#compilation-model) explores relevant compiler concepts. And, [Syntax Model](syntax-model) introduces Reach language syntax.
...
The syntax model, which involves the structure and content of Reach programs, is the subject of the [Computations](/en/books/essentials/backend-programming/computations/), [Modules](/en/books/essentials/backend-programming/modules/), [Modes](/en/books/essentials/backend-programming/modes/), and [JavaScript](/en/books/essentials/backend-programming/javascript/) pages collectively. 