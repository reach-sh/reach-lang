...
<div><img src="reach-dapp.png" class="img-fluid mb-3" width=800 height=439 loading="lazy"></div>
...
1. Buyer participant accounts *pay* currency to contract accounts which *transfer* currency to seller participant accounts.
