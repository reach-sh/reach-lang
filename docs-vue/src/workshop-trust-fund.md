...
XXX (workshop-deps "workshop-relay")
...
+ The Funder knows the identity of the Receiver, the amount, as well as the maturity of the fund, and the delays beforewhich it will be declared dormant or forsook.
...
@[code{1-21}](@reach-lang/examples/workshop-trust-fund/index.rsh)
...
Try this on your own based on your experience with XXX (secref "workshop-relay").
...
@[code](@reach-lang/examples/workshop-trust-fund/index.rsh)
...
@[code](@reach-lang/examples/workshop-trust-fund/index.mjs)
