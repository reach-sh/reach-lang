...
class Actor {
    ...
    async history() {
        ...
        const filtered = Object.filter(sg, ([id, state]) => state[1].contents.l_curr_actor_id === this.id);
        return filtered;
    }
}
...
export { ImperativeScenario, FunctionalScenario, Participant, Consensus, Action, Account, Token, View, API };
