    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(Array|Boolean|Date|Error|Function|Math|netscape|'
             ...
             # The reach ones
             r'UInt|Reach|App|Fun|Null|Bool|Bytes|Address|Tuple|Participant|ParticipantClass|Data|Digest|deployMode|verifyOverflow|verifyPerConnector|connectors|ETH|ALGO|'
