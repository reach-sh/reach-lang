  ...
  sendrecv join("A":T_Address:7) 1 (.publish(("array idx":T_UInt256:3,"array idx":T_UInt256:4), "prim":T_UInt256:8, ()))("array idx":T_UInt256:5, "array idx":T_UInt256:6){
    ...
    sendrecv join("B":T_Address:15) 2 ()().timeout(DLC_Int 10, {
      ...
      sendrecv again("A":T_Address:7) 9 (.publish((), DLC_Int 0, ("A":T_Address:7, "array idx":T_UInt256:5, "array idx":T_UInt256:6)))(){
        const "prim":T_UInt256:23 PL_Once = CP TXN_VALUE();
        const "prim":T_Bool:24 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:23);
        claim(CT_Require)("prim":T_Bool:24);
        exit(DLC_Bytes "Bob quits"); } }){
      const "prim":T_UInt256:16 PL_Once = CP TXN_VALUE();
      const "prim":T_Bool:17 PL_Once = CP PEQ("array idx":T_UInt256:5,"prim":T_UInt256:16);
      ...
      const "rockP (as prim)":T_Bool:31 PL_Many = CP BYTES_EQ("s (as interact)":T_Bytes:30,DLC_Bytes "ROCK");
      const "paperP (as prim)":T_Bool:32 PL_Many = CP BYTES_EQ("s (as interact)":T_Bytes:30,DLC_Bytes "PAPER");
      const "scissorsP (as prim)":T_Bool:33 PL_Once = CP BYTES_EQ("s (as interact)":T_Bytes:30,DLC_Bytes "SCISSORS");
      const "_handA (as prim)":T_Bool:35 PL_Once = CP IF_THEN_ELSE("rockP (as prim)":T_Bool:31,DLC_Bool True,"paperP (as prim)":T_Bool:32);
      const "_handA (as prim)":T_Bool:37 PL_Once = CP IF_THEN_ELSE("_handA (as prim)":T_Bool:35,DLC_Bool True,"scissorsP (as prim)":T_Bool:33);
      ...
      const "salt (as prim)":T_UInt256:45 PL_Many = RANDOM();
      const "commitment (as digest)":T_UInt256:46 PL_Once = digest("salt (as prim)":T_UInt256:45,"_handA (as clo app)":T_UInt256:29);
      ...
      sendrecv again("A":T_Address:7) 3 (.publish(("commitment (as digest)":T_UInt256:46), DLC_Int 0, ("A":T_Address:7, "array idx":T_UInt256:5, "array idx":T_UInt256:6, "B":T_Address:15)))("commitment (as digest)":T_UInt256:48).timeout(DLC_Int 10, {
        sendrecv again("B":T_Address:15) 8 ()(){
          const "prim":T_UInt256:56 PL_Once = CP TXN_VALUE();
          const "prim":T_Bool:57 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:56);
          claim(CT_Require)("prim":T_Bool:57);
          exit(DLC_Bytes "Alice quits"); } }){
        const "prim":T_UInt256:49 PL_Once = CP TXN_VALUE();
        const "prim":T_Bool:50 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:49);
        ...
        sendrecv again("B":T_Address:15) 4 ()("handB (as clo app)":T_UInt256:77).timeout(DLC_Int 10, {
          ...
          sendrecv again("A":T_Address:7) 7 (.publish((), DLC_Int 0, ("A":T_Address:7, "array idx":T_UInt256:5, "array idx":T_UInt256:6, "B":T_Address:15, "commitment (as digest)":T_UInt256:48)))(){
            const "prim":T_UInt256:85 PL_Once = CP TXN_VALUE();
            const "prim":T_Bool:86 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:85);
            claim(CT_Require)("prim":T_Bool:86);
            exit(DLC_Bytes "Bob quits"); } }){
          const "prim":T_UInt256:78 PL_Once = CP TXN_VALUE();
          const "prim":T_Bool:79 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:78);
          claim(CT_Require)("prim":T_Bool:79);
          const "prim":T_Bool:89 PL_Once = CP PLE(DLC_Int 0,"handB (as clo app)":T_UInt256:77);
          const "prim":T_Bool:90 PL_Once = CP PLT("handB (as clo app)":T_UInt256:77,DLC_Int 3);
          const "prim":T_Bool:92 PL_Once = CP IF_THEN_ELSE("prim":T_Bool:89,"prim":T_Bool:90,DLC_Bool False);
          claim(CT_Require)("prim":T_Bool:92);
          let "clo app":T_Bytes:94;
          const "prim":T_Bool:96 PL_Once = CP PLE(DLC_Int 0,"handB (as clo app)":T_UInt256:77);
          const "prim":T_Bool:97 PL_Once = CP PLT("handB (as clo app)":T_UInt256:77,DLC_Int 3);
          const "prim":T_Bool:99 PL_Once = CP IF_THEN_ELSE("prim":T_Bool:96,"prim":T_Bool:97,DLC_Bool False);
          claim(CT_Require)("prim":T_Bool:99);
          const "prim":T_Bool:100 PL_Once = CP PEQ("handB (as clo app)":T_UInt256:77,DLC_Int 0);
          if "prim":T_Bool:100 then {
            "clo app":T_Bytes:94 = DLC_Bytes "ROCK";
             }
          else {
            const "prim":T_Bool:101 PL_Once = CP PEQ("handB (as clo app)":T_UInt256:77,DLC_Int 1);
          ...
          sendrecv again("A":T_Address:7) 5 (.publish(("salt (as prim)":T_UInt256:45,"_handA (as clo app)":T_UInt256:29), DLC_Int 0, ("A":T_Address:7, "array idx":T_UInt256:5, "array idx":T_UInt256:6, "B":T_Address:15, "commitment (as digest)":T_UInt256:48, "handB (as clo app)":T_UInt256:77)))("salt (as prim)":T_UInt256:103, "_handA (as clo app)":T_UInt256:104).timeout(DLC_Int 10, {
            sendrecv again("B":T_Address:15) 6 ()(){
              const "prim":T_UInt256:112 PL_Once = CP TXN_VALUE();
              const "prim":T_Bool:113 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:112);
              claim(CT_Require)("prim":T_Bool:113);
              exit(DLC_Bytes "Alice quits"); } }){
            const "prim":T_UInt256:105 PL_Once = CP TXN_VALUE();
            const "prim":T_Bool:106 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:105);
            claim(CT_Require)("prim":T_Bool:106);
            const "digest":T_UInt256:116 PL_Once = digest("salt (as prim)":T_UInt256:103,"_handA (as clo app)":T_UInt256:104);
            const "prim":T_Bool:117 PL_Once = CP PEQ("commitment (as digest)":T_UInt256:48,"digest":T_UInt256:116);
            claim(CT_Require)("prim":T_Bool:117);
            const "prim":T_Bool:119 PL_Once = CP PLE(DLC_Int 0,"_handA (as clo app)":T_UInt256:104);
            const "prim":T_Bool:120 PL_Once = CP PLT("_handA (as clo app)":T_UInt256:104,DLC_Int 3);
            const "prim":T_Bool:122 PL_Once = CP IF_THEN_ELSE("prim":T_Bool:119,"prim":T_Bool:120,DLC_Bool False);
            claim(CT_Require)("prim":T_Bool:122);
            let "outcome (as clo app)":T_UInt256:124;
            const "validA (as prim)":T_Bool:126 PL_Once = CP PLE(DLC_Int 0,"_handA (as clo app)":T_UInt256:104);
            const "validA (as prim)":T_Bool:127 PL_Once = CP PLT("_handA (as clo app)":T_UInt256:104,DLC_Int 3);
            const "validA (as prim)":T_Bool:129 PL_Many = CP IF_THEN_ELSE("validA (as prim)":T_Bool:126,"validA (as prim)":T_Bool:127,DLC_Bool False);
            const "validB (as prim)":T_Bool:131 PL_Once = CP PLE(DLC_Int 0,"handB (as clo app)":T_UInt256:77);
            const "validB (as prim)":T_Bool:132 PL_Once = CP PLT("handB (as clo app)":T_UInt256:77,DLC_Int 3);
            const "validB (as prim)":T_Bool:134 PL_Many = CP IF_THEN_ELSE("validB (as prim)":T_Bool:131,"validB (as prim)":T_Bool:132,DLC_Bool False);
            const "outcome (as prim)":T_Bool:136 PL_Once = CP IF_THEN_ELSE("validA (as prim)":T_Bool:129,"validB (as prim)":T_Bool:134,DLC_Bool False);
            if "outcome (as prim)":T_Bool:136 then {
              const "outcome (as prim)":T_UInt256:137 PL_Once = CP SUB(DLC_Int 4,"handB (as clo app)":T_UInt256:77);
              const "outcome (as prim)":T_UInt256:138 PL_Once = CP ADD("_handA (as clo app)":T_UInt256:104,"outcome (as prim)":T_UInt256:137);
              const "outcome (as prim)":T_UInt256:139 PL_Once = CP MOD("outcome (as prim)":T_UInt256:138,DLC_Int 3);
  ...
  sendrecv join("A":T_Address:7) 1 ()("array idx":T_UInt256:5, "array idx":T_UInt256:6){
    ...
    sendrecv join("B":T_Address:15) 2 (.publish((), "array idx":T_UInt256:5, ("A":T_Address:7, "array idx":T_UInt256:5, "array idx":T_UInt256:6)))().timeout(DLC_Int 10, {
      ...
      sendrecv again("A":T_Address:7) 3 ()("commitment (as digest)":T_UInt256:48).timeout(DLC_Int 10, {
        ...
        const "rockP (as prim)":T_Bool:63 PL_Many = CP BYTES_EQ("s (as interact)":T_Bytes:62,DLC_Bytes "ROCK");
        const "paperP (as prim)":T_Bool:64 PL_Many = CP BYTES_EQ("s (as interact)":T_Bytes:62,DLC_Bytes "PAPER");
        const "scissorsP (as prim)":T_Bool:65 PL_Once = CP BYTES_EQ("s (as interact)":T_Bytes:62,DLC_Bytes "SCISSORS");
        const "handB (as prim)":T_Bool:67 PL_Once = CP IF_THEN_ELSE("rockP (as prim)":T_Bool:63,DLC_Bool True,"paperP (as prim)":T_Bool:64);
        const "handB (as prim)":T_Bool:69 PL_Once = CP IF_THEN_ELSE("handB (as prim)":T_Bool:67,DLC_Bool True,"scissorsP (as prim)":T_Bool:65);
        ...
        sendrecv again("B":T_Address:15) 4 (.publish(("handB (as clo app)":T_UInt256:61), DLC_Int 0, ("A":T_Address:7, "array idx":T_UInt256:5, "array idx":T_UInt256:6, "B":T_Address:15, "commitment (as digest)":T_UInt256:48)))("handB (as clo app)":T_UInt256:77).timeout(DLC_Int 10, {
          ...
          claim(CT_Require)("prim":T_Bool:92);
          claim(CT_Require)(DLC_Bool True);
          sendrecv again("A":T_Address:7) 5 ()("salt (as prim)":T_UInt256:103, "_handA (as clo app)":T_UInt256:104).timeout(DLC_Int 10, {
...

{
  ...
  5 = {
    ...
    , "commitment (as digest)":T_UInt256:48
    , "handB (as clo app)":T_UInt256:77 ],
    ["salt (as prim)":T_UInt256:103, "_handA (as clo app)":T_UInt256:104],
    {
      const "prim":T_UInt256:105 PL_Once = CP TXN_VALUE();
      const "prim":T_Bool:106 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:105);
      claim(CT_Require)("prim":T_Bool:106);
  ...
  6 = {
    ...
    [],
    {
      ...
      const "prim":T_Bool:113 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:112);
      claim(CT_Require)("prim":T_Bool:113);
      const "prim":T_UInt256:114 PL_Once = CP BALANCE();
  ...
  7 = {
    ...
    [],
    {
      ...
      const "prim":T_Bool:86 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:85);
      claim(CT_Require)("prim":T_Bool:86);
      const "prim":T_UInt256:87 PL_Once = CP BALANCE();
  ...
  8 = {
    ...
    [],
    {
      ...
      const "prim":T_Bool:57 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:56);
      claim(CT_Require)("prim":T_Bool:57);
      const "prim":T_UInt256:58 PL_Once = CP BALANCE();
  ...
  9 = {
    ...
    [],
    {
      ...
      const "prim":T_Bool:24 PL_Once = CP PEQ(DLC_Int 0,"prim":T_UInt256:23);
      claim(CT_Require)("prim":T_Bool:24);
      const "prim":T_UInt256:25 PL_Once = CP BALANCE();
