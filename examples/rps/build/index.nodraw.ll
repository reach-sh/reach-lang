...
publish("A", join("A":T_Address:7))("tuple idx":T_UInt256:3,"tuple idx":T_UInt256:4)("tuple idx":T_UInt256:5, "tuple idx":T_UInt256:6).pay("prim":T_UInt256:8){
  ...
  commit();
  only("B") {
    const "interact":T_Null:13 = interact("B")."acceptParams"("tuple idx":T_UInt256:5,"tuple idx":T_UInt256:6);
     };
  claim(CT_Require)(DLC_Bool True);
  only("B") {
     };
  publish("B", join("B":T_Address:14))()().pay("tuple idx":T_UInt256:5).timeout((DLC_Int 10, {
    only("A") {
       };
    ...
    const "prim":T_Bool:16 = PEQ("tuple idx":T_UInt256:5,"prim":T_UInt256:15);
    ...
    invariant{
      ...
      const "prim":T_UInt256:28 = MUL(DLC_Int 2,"tuple idx":T_UInt256:5);
      const "prim":T_UInt256:29 = ADD("prim":T_UInt256:28,"tuple idx":T_UInt256:6);
    ...
    if "one of [\"getsA\",\"getsB\"] (as prim)":T_Bool:227 then {
      const "one of [\"getsA\",\"getsB\"] (as prim)":T_UInt256:228 = MUL(DLC_Int 2,"tuple idx":T_UInt256:5);
      ...
      if "one of [\"getsA\",\"getsB\"] (as prim)":T_Bool:229 then {
        const "one of [\"getsA\",\"getsB\"] (as prim)":T_UInt256:230 = MUL(DLC_Int 2,"tuple idx":T_UInt256:5);
    ...
    const "tuple idx":T_UInt256:231 = "one of [\"getsA\",\"getsB\"] (as clo app)":T_Tuple [T_UInt256,T_UInt256]:226[0];
    const "tuple idx":T_UInt256:232 = "one of [\"getsA\",\"getsB\"] (as clo app)":T_Tuple [T_UInt256,T_UInt256]:226[1];
    const "prim":T_UInt256:233 = ADD("tuple idx":T_UInt256:6,"tuple idx":T_UInt256:231);
