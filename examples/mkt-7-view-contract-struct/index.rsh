...
const buyerInteract = {
  ...commonInteract,
  shop: Fun(
    [Struct([["announcement", announcement], ["products", products]])],
    Struct([["prodNum", UInt], ["prodAmt", UInt]])
  ),
...
export const main = Reach.App(() => {
  ...
  const V = View('Main', { sellerInfo: Struct([["announcement", announcement], ["products", products]]) });
  init();
